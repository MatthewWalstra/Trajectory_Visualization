...
class TrajectoryIterator:
    ...
    def __init__(self, trajectory):
        ...
        self.start_t = trajectory.points[0].t
        self.end_t = trajectory.points[trajectory.trajectory_length() - 1].t
    ...
    def advance(self, additional_progress):
        ...
        self.progress = limit2(self.progress + additional_progress, self.start_t, self.end_t)
